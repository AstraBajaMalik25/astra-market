...
export default function About() {
  return (
    <div className="about">
      <h2>Tentang Kami</h2>
      <p>
        Astra Market adalah platform e-commerce yang menyediakan berbagai pakaian
        dan aksesoris modern untuk semua kalangan. Kami berkomitmen memberikan
        pengalaman belanja yang mudah, cepat, dan aman.
      </p>
      <p>
